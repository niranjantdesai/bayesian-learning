...
for i in range(M):
    ...
    network = ToyNet("eval_SGLD-64_1", project_dir="../toyRegression")
    network.load_state_dict(torch.load("../toyRegression/training_logs/model_SGLD-64_1/checkpoints/model_SGLD-64_1_epoch_%d.pth" % int(num_epochs - i*step_size)))
...
plt.savefig("../mu_alea_pred_true.png" )
plt.close(1)
...
plt.savefig("../alea_pred_true.png")
plt.close(1)
...
plt.savefig("../mu_epi_pred_true.png")
plt.close(1)
...
plt.savefig("../mu_tot_pred_true.png")
plt.close(1)

with open("../HMC/x_values.pkl", "rb") as file: # (needed for python3)
    x_values_HMC = pickle.load(file) # (list of 1000 elements)

with open("../HMC/final_mean_values.pkl", "rb") as file: # (needed for python3)
    mean_values_HMC = pickle.load(file) # (list of 1000 elements)

with open("../HMC/final_sigma_tot_values.pkl", "rb") as file: # (needed for python3)
...
plt.savefig("../predictive_density_GT_.png")
plt.close(1)
...
plt.ylim([-4.25, 4.25])
plt.tight_layout(pad=0.1, w_pad=0.1, h_pad=0.1)
plt.savefig("../predictive_density_HMC_.png")
plt.close(1)
...
plt.ylim([-4.25, 4.25])
plt.tight_layout(pad=0.1, w_pad=0.1, h_pad=0.1)
plt.savefig("../predictive_density_.png")
plt.close(1)
...
for param_index in range(10):
    ...
    plt.savefig("../param_distributions/fc1_mean_weight_%d.png" % (param_index))
    plt.close(1)
...
for param_index in range(10):
    ...
    plt.figure(1)
    plt.hist(np.array(values), bins=100)
    plt.savefig("../param_distributions/fc1_mean_bias_%d.png" % (param_index))
    plt.close(1)
...
for param_index_i in range(10):
    for param_index_j in range(10):
        ...
        plt.figure(1)
        plt.hist(np.array(values), bins=100)
        plt.savefig("../param_distributions/fc2_mean_weight_%d_%d.png" % (param_index_i, param_index_j))
        plt.close(1)
...
for param_index in range(10):
    ...
    plt.figure(1)
    plt.hist(np.array(values), bins=100)
    plt.savefig("../param_distributions/fc2_mean_bias_%d.png" % (param_index))
    plt.close(1)
...
for param_index in range(10):
    ...
    plt.figure(1)
    plt.hist(np.array(values), bins=100)
    plt.savefig("../param_distributions/fc3_mean_weight_%d.png" % (param_index))
    plt.close(1)
...
plt.figure(1)
plt.hist(np.array(values), bins=100)
plt.savefig("../param_distributions/fc3_mean_bias.png" )
plt.close(1)
...
for param_index in range(10):
    ...
    plt.figure(1)
    plt.hist(np.array(values), bins=100)
    plt.savefig("../param_distributions/fc1_var_weight_%d.png" % (param_index))
    plt.close(1)
...
for param_index in range(10):
    ...
    plt.figure(1)
    plt.hist(np.array(values), bins=100)
    plt.savefig("../param_distributions/fc1_var_bias_%d.png" % (param_index))
    plt.close(1)
...
for param_index_i in range(10):
    for param_index_j in range(10):
        ...
        plt.figure(1)
        plt.hist(np.array(values), bins=100)
        plt.savefig("../param_distributions/fc2_var_weight_%d_%d.png" % ( param_index_i, param_index_j))
        plt.close(1)
...
for param_index in range(10):
    ...
    plt.figure(1)
    plt.hist(np.array(values), bins=100)
    plt.savefig("../param_distributions/fc2_var_bias_%d.png" % (param_index))
    plt.close(1)
...
for param_index in range(10):
    ...
    plt.figure(1)
    plt.hist(np.array(values), bins=100)
    plt.savefig("../param_distributions/fc3_var_weight_%d.png" % (param_index))
    plt.close(1)
...
plt.figure(1)
plt.hist(np.array(values), bins=100)
plt.savefig("../param_distributions/fc3_var_bias.png")
plt.close(1)
